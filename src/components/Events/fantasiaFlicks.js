...
const E1 = () => {
  ...
  return (
    <div className="individual-event flex flex-col justify-center items-center min-h-screen">
      <div className="flex justify-center items-center short-film lg:w-[500px] lg:h-[700px] w-[250px] h-[300px] mt-2">
        {/* <img
        ...
        <div className="flex flex-col lg:flex-row  justify-between">
          <div className=" px-3 flex flex-col lg:ml-[70px] ml-[10px]">
            ...
            <ol className="mt-2 lg:text-[25px] text-[15px]">
              ...
              <li>
                2. <b>Duration :</b> 3-5 minutes (including title and credits)
              </li>
              <li>
                3. <b>Cinematography :</b> Mobile and Camera allowed
              </li>
              <li>
                4. <b>Editing :</b> On computer or mobile
              </li>
              <li>
                5. <b>Output :</b> 1080p HD, 16:9 Landscape
              </li>
              <li>
                6. <b>Format :</b> .mp4
              </li>
              <li>
                7. <b>Submission :</b> Film + unedited raw footage for scrutiny
              </li>
              <li>
                8. <b>Submission to :</b> marketing@mesmerizernsec.live
              </li>
              <li>
                9. <b>Prohibited :</b> Controversial, nudity, violence, racism,
                religious, caste discrimination{" "}
              </li>
              <li>
                10. <b>Team Size :</b> 5-7 members per team
              </li>
            </ol>
          </div>
          <div className="px-3 flex flex-col lg:justify-between ml-[10px] lg:mr-[140px]">
            ...
            <div className="">
              ...
              <p className="lg:text-[40px] text-[15px] text-[#FF0000]">₹250</p>
            </div>
          </div>
        </div>
            ...
            <ol className="mt-1 lg:text-[25px] text-[15px]">
              <li>
                <div className="flex space-x-4">
                  ...
                  <div className="flex-none">10th January, 2024</div>
                </div>
              </li>
              {/* <li>
                <div className="flex space-x-4">
