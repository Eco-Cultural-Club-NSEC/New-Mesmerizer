...
const E1 = () => {
  ...
  return (
    <div className="individual-event flex flex-col justify-center items-center min-h-screen">
      <div className="flex justify-center items-center street-dance lg:h-[600px] lg:w-[1000px] h-[200px] w-[300px] mt-4">
        {/* <img
        ...
        <div className="flex flex-col lg:flex-row  justify-between">
          <div className=" px-3 flex flex-col lg:ml-[70px] ml-[10px]">
            ...
            <ol className="mt-2 lg:text-[25px] text-[15px]">
              <li>
                1. <b>Song selection</b>: Instantly played by a designated judge
                or cultural coordinator.
              </li>
              <li>
                2. <b>Opponent Selection:</b> Fair competition is ensured
                through cheat-proof, name-wise opponent selection.
              </li>
              <li>
                3. <b>Time Allotment:</b> Precise performance window of 1.5 to 2
                minutes per participant.
              </li>
              <li>
                4.<b> Costume Policy:</b> Participants are exempted from costume
                requirements.
              </li>
              <li>
          ...
          <div className="px-3 flex flex-col lg:justify-between ml-[10px] lg:mr-[140px]">
            ...
            <div className="">
              ...
              <p className="lg:text-[40px] text-[15px] text-[#FF0000]">₹60</p>
            </div>
          </div>
        </div>
