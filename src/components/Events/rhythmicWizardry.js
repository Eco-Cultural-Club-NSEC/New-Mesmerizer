...
const E1 = () => {
  ...
  return (
    <div className="individual-event flex flex-col justify-center items-center min-h-screen">
      <div className="flex justify-center items-center beat-box s lg:h-[600px] lg:w-[1000px] h-[200px] w-[300px] mt-4">
        {/* <img
        ...
        <div className="flex flex-col lg:flex-row  justify-between">
          <div className=" px-3 flex flex-col lg:ml-[70px] ml-[10px]">
            ...
            <ol className="mt-2 lg:text-[25px] text-[15px]">
              <li>
                1. <b>Participant Type :</b> Individual
              </li>
              <li>
                2. <b>Additional Beatboxing :</b> Not permitted on the
                soundtrack.
              </li>
              <li>
                3. <b>Cheats :</b> Provided for opponent selection.
              </li>
              <li>
                4. <b>Judging :</b> The winner is selected by an expert jury.
              </li>
              <li>
                5. <b>Note :</b> Rules are subject to change at the discretion
          ...
          <div className="px-3 flex flex-col lg:justify-between ml-[10px] lg:mr-[140px]">
            <div className="">
              ...
              <ol className="mt-1 lg:text-[25px] text-[15px]">
                <li>Poulomi Guha - +91 74391 36033</li>
                <li>Anubhab Dolai - +91 83918 44898</li>
              </ol>
            </div>
            <div className="">
              <span className="lg:text-[63px] text-[20px] lg:mt-0 mt-3 ">
