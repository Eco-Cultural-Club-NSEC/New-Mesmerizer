...
const E1 = () => {
  ...
  return (
    <div className="individual-event flex flex-col justify-center items-center lg:h-[200vh] h-[200vh]">
      ...
      <h2 className="align middle lg:text-[30px] text-[20px] text-white">Western Solo Dance</h2>
      </div>
        ...
        <div className="flex flex-col lg:flex-row  justify-between">
          <div className=" px-3 flex flex-col lg:ml-[70px] ml-[10px]">
            ...
            <ol className="mt-2 lg:text-[30px] text-[15px]">
              <li>
                1. <b>Duration:</b> 4 minutes per individual
              </li>
              <li>
                2. <b>Dance Forms:</b> Any Western dance style is permitted.
              </li>
              <li>
              ...
              <li>
                4. <b>Music: </b> Teams must bring their music track on a
                Pendrive with a backup on a phone.
              </li>
            </ol>
          </div>
