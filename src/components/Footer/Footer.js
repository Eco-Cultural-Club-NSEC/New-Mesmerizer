  ...
  return (
    <div className="footer lg:h-[110vh] h-[100vh] flex flex-col justify-center items-center">
      ...
      <div className="content flex justify-center items-center text-white lg:mt-[100px] lg:flex-row flex-col">
        <div className="address flex flex-col items-center lg:mr-10 lg:text-[20px] text-[12px] lg:mt-0 mt-[40px]">
          <h1>Netaji Subhash Engineering College</h1>
          <div className="add w-[90%] lg:mt-6 mt-3 flex flex-col items-center justify-center  lg:left-0 left-1">
            <div className="line1 flex lg:w-[287px] w-[100%]">
              <i class="fa-solid fa-location-dot relative top-2 mr-3"></i>
              <p>Mauza Ranabhutia, Techno City, Garia, West Bengal 700152</p>
            </div>
            <div className="line2 flex lg:w-[350px] w-[100%] mt-1">
      ...
      <div className="credits lg:text-[19px] text-[9px] text-white flex flex-col justify-center items-center lg:mt-[70px] mt-[30px]">
